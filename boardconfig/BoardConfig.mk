...
#Galaxy S2 daliskt e120s - daliskt
...
#Galaxy S2 dalilgt e120l - dalilgt
else ifeq ($(TARGET_PRODUCT), cm_dalilgt)
    TARGET_COMMON_NAME := daliskt e120l;
    BOOTLOADER_CMD_ARG := "download"
    KERNEL_EXFAT_MODULE_NAME := "exfat"
    KERNEL_NTFS_MODULE_NAME := "ntfs"
    TARGET_SCREEN_HEIGHT := 1280
...
else ifneq ($(filter $(TARGET_PRODUCT),cm_hltexx cm_hltespr cm_hltetmo cm_hltecan cm_hltevzw cm_hlte),)
